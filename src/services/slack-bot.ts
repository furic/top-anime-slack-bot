...
class SlackBot {
  ...
  private getAnimeEmoji(anime: AnimeDetails): string {
    ...
    const standardEmojis = [
      ...
      'eject_button', 'cinema', 'antenna_bars', 'vibration_mode', 'mobile_phone_off',
      'female_sign', 'male_sign', 'medical_symbol', 'infinity', 'recycling_symbol',
      'fleur-de-lis', 'trident_emblem', 'name_badge', 'japanese_symbol_for_beginner',
